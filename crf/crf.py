...
'''
代码来自“https://github.com/applenob/simple_crf/blob/master/crf.py”
感谢原作者提供代码，转载请注明原作者
'''
...
class CRF:
    ...
    def create_vector_list(self, x_vecs, y_vecs):
        ...
        observation = [self.get_all_features(x_vec) for x_vec in x_vecs]
        labels = len(y_vecs) * [None]

        # 标签与id对应，给每条训练数据增加首尾标记符
